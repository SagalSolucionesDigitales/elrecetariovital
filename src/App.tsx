...
function Pain() {
  const items = [
    ...
    { pain: "Tu médico te dijo que, si no cambias tu alimentación, eso 'insignificante' se puede convertir en algo realmente grave.", answer: "Nadie te explicó qué comer ni por dónde empezar para comer saludable y cuidar tu salud. El Recetario Vital es tu guía práctica para aprender a alimentarte sin depender de una consulta médica para cada decisión." },
    ...
    <section className="px-5 py-16 md:py-24 bg-white">
      <div className="max-w-5xl mx-auto">
        ...
        <p className="text-center text-lg md:text-xl mt-10 font-semibold" style={{ color: GREEN }}>
          Si te identificaste con al menos una… este recetario es lo que buscaste por tanto tiempo.
        </p>
      </div>
    </section>
  );
...
function ScientificEvidence() {
  const cards = [
    { emoji: "🌿", title: "Canela de Ceilán", body: "Estudios publicados en el Journal of Medicinal Food muestran que el consumo regular de canela de Ceilán está asociado con una reducción en los niveles de glucosa en ayunas. La encontrarás en varias recetas del Recetario Vital, no como adorno, sino como ingrediente funcional." },
    ...
    { emoji: "🫘", title: "Legumbres (lentejas, garbanzos, frijoles)", body: "Las legumbres tienen uno de los índices glucémicos más bajos entre los alimentos ricos en carbohidratos. Son base fundamental de las recetas del Recetario Vital porque sacian, nutren y no disparan el azúcar. Son económicas y fáciles de conseguir en cualquier mercado de LATAM." },
    { emoji: "🌾", title: "Avena integral", body: "La fibra beta-glucano de la avena es reconocida por organismos de salud internacionales como aliada en el control del azúcar en sangre. En el Recetario encontrarás formas de prepararla que van mucho más allá del desayuno tradicional." },
    { emoji: "🥑", title: "Aguacate, aceite de oliva y semillas", body: "Las grasas monoinsaturadas presentes en el aguacate y el aceite de oliva virgen extra han sido asociadas en múltiples estudios con la reducción de la inflamación crónica, uno de los factores subyacentes en la resistencia a la insulina." },
  ];
  return (
    <section className="px-5 py-16 md:py-24 bg-white">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mx-auto mt-6 mb-10 rounded-xl p-6" style={{ backgroundColor: CREAM, borderLeft: `6px solid ${TERRACOTTA}`, maxWidth: 760 }}>
          <p style={{ color: INK, fontSize: 16, lineHeight: 1.7 }}>
            Una alimentación familiar equilibrada, basada en ingredientes naturales y recetas reales, es uno de los factores con mayor impacto en la prevención de enfermedades crónicas en el hogar. Estudios en nutrición familiar demuestran que los patrones de alimentación del entorno directo influyen decisivamente en los hábitos de cada integrante — incluidas las personas con prediabetes, riesgo metabólico, colesterol, entre otras condiciones, quienes pueden estabilizar sus niveles con cambios sostenidos en lo que come toda la familia.
          </p>
        </div>
        <div className="grid md:grid-cols-2 gap-5 mt-6">
          {cards.map((c) => (
            <div key={c.title} className="rounded-xl p-6" style={{ backgroundColor: CREAM, borderLeft: `4px solid ${GREEN}` }}>
        ...
        <div className="mt-10 mx-auto rounded-lg" style={{ backgroundColor: CREAM, border: `1px solid ${GREEN}`, padding: 20, maxWidth: 720 }}>
          <p className="italic text-center" style={{ color: INK, fontSize: 16 }}>
            El Recetario Vital es un recurso de alimentación complementario. No reemplaza tu tratamiento médico ni las indicaciones de tu médico o nutricionista.
          </p>
        </div>
      </div>
    </section>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-10 mt-10 items-center">
          <div className="flex justify-center">
            <img src={benefitsMockup} alt="Recetario Vital mostrado en un teléfono móvil" width={360} height={520} className="w-full max-w-[360px] h-auto rounded-2xl" loading="lazy" decoding="async" />
          </div>
          <ul className="space-y-4">
            {[
              ...
              <li key={b} className="flex gap-3 items-start">
                <span className="flex-shrink-0 w-7 h-7 mt-0.5 rounded-full flex items-center justify-center font-bold text-white text-sm" style={{ backgroundColor: GREEN }}>✓</span>
                <p style={{ color: INK, fontSize: 16 }} className="leading-relaxed">{b}</p>
              </li>
            ))}
          </ul>
        </div>
...
function Testimonials() {
  const list = [
    ...
    { quote: "Quienes tenemos el azúcar alta vivimos en constante estrés por no saber qué hacer. Desde que mi esposa cambió nuestra dieta, todos nos hemos beneficiado, pero especialmente yo que logré mantener controlados mis niveles de azúcar. El Recetario Vital te da una guía para no sacrificar el placer de comer, cuidando tu salud.", name: "Cristian Ortiz", city: "Lima", img: testimonialCristian },
    ...
    { quote: "Cuando te diagnostican con diabetes sentís que nada volverá a ser como antes. Pero cuando encuentras una herramienta como el Recetario Vital, te das cuenta que podés seguir llevando una vida normal. Es ideal para que toda la familia se alimente saludablemente, cuide su salud y prevenga enfermedades.", name: "Carlos Martínez", city: "La Plata", img: testimonialCarlos },
  ];
  return (
...
function Bonuses() {
  const bonuses = [
    { tag: "🎁 BONO 1", emoji: "🚦", title: "El Semáforo Alimenticio", body: "La guía visual que te dice en segundos qué alimentos te ayudan y cuáles te dañan. Como tener un nutricionista silencioso 24/7.", value: "$15 USD" },
    { tag: "🎁 BONO 2", emoji: "🥑", title: "Keto Fácil", body: "Guía de inicio rápido para la alimentación cetogénica antiinflamatoria. Todo lo que necesitas para empezar sin confusión, sin hambre y sin errores.", value: "$17 USD" },
    { tag: "🎁 BONO 3", emoji: "💧", title: "Detox Natural", body: "21 licuados y aguas infusionadas para desinflamar y depurar tu cuerpo desde adentro. El complemento perfecto para potenciar tu alimentación diaria.", value: "$25 USD" },
  ];
  return (
    <section className="px-5 py-16 md:py-24" style={{ backgroundColor: CREAM }}>
      <div className="max-w-5xl mx-auto">
        <SectionLabel>Bonos exclusivos — solo por hoy</SectionLabel>
        <Heading>Con tu Recetario Vital lleva 3 bonos exclusivos — Sin costo adicional</Heading>
        <p className="text-center mb-10" style={{ color: INK, fontSize: 18 }}>
          Valorados en <strong>$57 USD</strong>. Tuyos GRATIS hoy.
        </p>
        <div className="grid md:grid-cols-3 gap-5">
          {bonuses.map((b) => (
            <div key={b.title} className="bg-white rounded-2xl p-6 shadow-sm flex flex-col" style={{ border: `1px solid ${GREEN}20` }}>
              <span className="inline-block self-start text-xs font-bold uppercase tracking-wider px-3 py-1 rounded-full mb-3" style={{ backgroundColor: TERRACOTTA, color: "#fff" }}>{b.tag}</span>
              <h3 className="font-display font-bold text-xl mb-2" style={{ color: GREEN }}><span className="mr-2">{b.emoji}</span>{b.title}</h3>
              <p style={{ color: INK, fontSize: 16 }} className="mb-4 flex-1">{b.body}</p>
        ...
        <div className="mt-12">
          ...
          <p className="mt-4 text-center text-sm text-neutral-500">Acceso inmediato en menos de 2 minutos • PDF en español</p>
        </div>
      </div>
    </section>
  );
    ...
    <section className="px-5 py-16 md:py-24" style={{ backgroundColor: GREEN }}>
      <div className="max-w-3xl mx-auto text-center">
        ...
        <p className="mx-auto mb-8 text-white/90" style={{ fontSize: 18, maxWidth: 620 }}>
          Por una inversión mínima, muy inferior al costo de una consulta médica o con un nutricionista, llevas hoy tu Recetario Vital:
        </p>
        ...
        <p className="text-gray-300 mb-2" style={{ fontSize: 24, textDecoration: "line-through" }}>$92 USD</p>
        <p className="text-white/80 mb-2 text-sm uppercase tracking-widest">Hoy solo</p>
        <p className="text-white font-extrabold leading-none mb-4" style={{ fontSize: "clamp(48px, 11vw, 72px)", fontWeight: 800 }}>$15 USD</p>
        <p className="text-white/90 mb-6 mx-auto" style={{ fontSize: 16, maxWidth: 520 }}>
          Un solo pago. Tuyo de por vida. Con actualizaciones permanentes incluidas.
        </p>
        <p className="text-white/85 mb-6" style={{ fontSize: 16 }}>
          ≈ $321 MXN · ≈ $56.404 COP<br />
          <span className="italic" style={{ color: CREAM, fontSize: 13 }}>(El precio exacto se confirma en el checkout)</span>
        </p>
        <div className="mx-auto mb-8 text-white font-bold text-center" style={{ backgroundColor: TERRACOTTA, borderRadius: 8, padding: "12px 20px", maxWidth: 560, fontSize: 16 }}>
          ⏱️ Solo durante el lanzamiento: $15 USD — Precio especial para los primeros 50 compradores.
        </div>
        <div className="mx-auto mb-8 rounded-xl text-left" style={{ backgroundColor: "rgba(255,255,255,0.08)", border: "1px solid rgba(255,255,255,0.2)", padding: 24, maxWidth: 560 }}>
          ...
          <p className="text-white" style={{ fontSize: 16, lineHeight: 1.7 }}>
            ...
            Pago procesado por <strong>Hotmart</strong>, la plataforma de productos digitales más grande de América Latina. Tus datos están protegidos con encriptación SSL. Nunca almacenamos información de tu tarjeta.<br /><br />
...
function FAQ() {
  const faqs: { q: string; a: React.ReactNode }[] = [
    { q: "¿En qué formato recibo el Recetario?", a: "Lo recibes en formato PDF, listo para leer en tu celular, tablet o computador. También puedes imprimirlo si lo prefieres." },
    { q: "¿Cuándo lo recibo después de pagar?", a: "La descarga es inmediata. En menos de 2 minutos recibirás el acceso a tu correo electrónico junto con los 3 bonos." },
    { q: "¿Sirve si vivo fuera de LATAM?", a: "Sí. Aunque las recetas están pensadas con ingredientes accesibles en LATAM, todos son fáciles de conseguir en cualquier país." },
    ...
    { q: "¿Qué pasa si no cumple mis expectativas?", a: (<>Tienes 7 días para revisarlo. Si por cualquier razón no estás satisfecho, solicita la devolución en <strong>Hotmart</strong> y te devolvemos el 100% en menos de 48 horas. Sin formularios. Sin explicaciones. Sin discusiones.</>) },
    { q: "¿Es seguro pagar aquí?", a: (<>Sí. El pago lo procesa <strong>Hotmart</strong>, líder en productos digitales en América Latina con más de 35 millones de compradores. Tu información tiene encriptación de nivel bancario.</>) },
  ];
  return (
    <section className="px-5 py-16 md:py-24 bg-white">
  ...
  return (
    <footer className="px-5 py-10" style={{ backgroundColor: GREEN }}>
      <div className="max-w-5xl mx-auto text-center text-white/80 text-sm">
        ...
        <p className="mb-2">© {new Date().getFullYear()} Recetario Vital. Todos los derechos reservados.</p>
